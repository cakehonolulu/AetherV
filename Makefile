...
RTL       := alu.v control_unit.v core.v instr_mem.v \
             led_driver.v pc.v regfile.v top.v \
             uart_tx.v uart_peripheral.v uart_logger.v
...
hw:
	...
	"read_verilog $(RTL); synth_gowin -json rv32i.json -family gw2a"
